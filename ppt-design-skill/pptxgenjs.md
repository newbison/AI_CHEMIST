...
| `angle` | number | 0-359 degrees | Direction (135 = bottom-right) |
...
6. **NEVER reuse option objects across calls** - PptxGenJS mutates objects in-place. Use factory functions:
   ```javascript
